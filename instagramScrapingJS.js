...
(async () => {
  try {
    ...
    // followers txt
    var followers_doc = document.createElement("a");
    followers_doc.href = window.URL.createObjectURL(new Blob([JSON.stringify(followers)], {type: "text/plain"}));
    followers_doc.download = "followers.txt";
    followers_doc.click();
    
    var following_doc = document.createElement("a");
    following_doc.href = window.URL.createObjectURL(new Blob([JSON.stringify(followings)], {type: "text/plain"}));
    following_doc.download = "following.txt";
    following_doc.click();
